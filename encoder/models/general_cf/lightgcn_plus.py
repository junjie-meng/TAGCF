...
class LightGCN_plus(BaseModel):
    def __init__(self, data_handler):
        ...
        self.attr_embeds = nn.Parameter(init(t.empty(self.attr_num, self.embedding_size))) if self.attr_num > 0 else None
    ...
    def forward(self, adj=None, keep_rate=1.0):
        ...
        if self.attr_embeds is None:
            ...
            embeds = t.concat([self.user_embeds, self.item_embeds, self.attr_embeds], axis=0)
        embeds_list = [embeds]
        if self.is_training:
